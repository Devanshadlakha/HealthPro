    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/slots/approve-change").hasRole("DOCTOR")
                .requestMatchers("/slots/reject-change").hasRole("DOCTOR")
                ...
                .requestMatchers("/payment/pay-on-visit").hasRole("PATIENT")
